...
'''
Change configuration accordingly for experiments

## ch_idx 
Change ch_idx accordingly for testing single / multi channel
I specifically tested these settings:
1 channel - (C3-M2)
3 channels - (C3-M2, E1-M2, Chin1-Chin2)
5 channels - (C3-M2, E1-M2, Chin1-Chin2, Airflow, ECG)

## probe_mode
Change probe_mode to change the classifier type.
Two options available are
probe_mode = 'linear' or 'SVM'
'Linear' is simple linear classifier,
'SVM' uses GridSearch along different parameters in Support Vector Classifier in sklearn

## freeze
Use this option to freeze and unfreeze embedder & encoder block of model

## use_subset
Use this option to test if file runs smoothly using small subset of data.
'''
...
def evaluate_epoch(dataloader, model, criterion, device, reduction='mean', group_size=7):
    ...
    with torch.no_grad():
        for batch_x, batch_mask, batch_labels in dataloader:
            ...
            # make sure batch is divisible by group_size
...
if args.probe_mode == 'linear':
    model = MOMENTPipeline.from_pretrained(
    "AutonLab/MOMENT-1-large", 
    model_kwargs={
        'task_name': 'classification',
        'n_channels': len(args.ch_idx), # number of input channels
        'num_class': 5,
        'freeze_encoder': args.freeze, # Freeze the patch embedding layer
        'freeze_embedder': args.freeze, # Freeze the transformer encoder
...
# =====================
# Mean: 0.00, Std: 50.95
# /ssd/kdpark/anaconda3/envs/moment_dj/lib/python3.11/site-packages/momentfm/models/moment.py:174: UserWarning: Only reconstruction head is pre-trained. Classification and forecasting heads must be fine-tuned.
#   warnings.warn("Only reconstruction head is pre-trained. Classification and forecasting heads must be fine-tuned.")
#   0%|                                                                                                        | 0/9709 [00:00<?, ?it/s]/ssd/kdpark/anaconda3/envs/moment_dj/lib/python3.11/site-packages/torch/_dynamo/eval_frame.py:929: UserWarning: torch.utils.checkpoint: the use_reentrant parameter should be passed explicitly. In version 2.5 we will raise an exception if use_reentrant is not passed. use_reentrant=False is recommended, but if you need to preserve the current default behavior, you can pass use_reentrant=True. Refer to docs for more details on the differences between the two variants.
#   return fn(*args, **kwargs)
# /ssd/kdpark/anaconda3/envs/moment_dj/lib/python3.11/site-packages/torch/utils/checkpoint.py:85: UserWarning: None of the inputs have requires_grad=True. Gradients will be None
#   warnings.warn(
# 100%|██████████████████████████████████████████████████████████████████████████████████████████| 9709/9709 [12:11:16<00:00,  4.52s/it]
#   9%|███████▉                                                                     9%|███████▉                                                                     9%|████████                                                                                    | 223/2563 [16:05<2:48:39,  4.32s/it]conda activate moment_dj
# 100%|███████████████████████████████████████████████████████████████████████████████████████████| 2563/2563 [3:04:52<00:00,  4.33s/it]
# <class 'sklearn.svm._classes.SVC'>
# {'C': 10, 'break_ties': False, 'cache_size': 200, 'class_weight': None, 'coef0': 0, 'decision_function_shape': 'ovr', 'degree': 3, 'gamma': 'scale', 'kernel': 'rbf', 'max_iter': 10000000, 'probability': True, 'random_state': None, 'shrinking': True, 'tol': 0.001, 'verbose': False}
# Grouped accuracy: 0.67
# Per-class F1: [0.74580434 0.1806464  0.75405838 0.65605718 0.5277276 ]
# Macro F1: 0.5728587808986937